...
let continuar;
        ...
        function venta(){
                        ...
                        listaCliente.push(productoNuevoCliente)
...
function busc (){
        let busquedaUsuario = prompt("Ingrese el nombre del producto que esta buscando")
                        let resultadoBusqueda = listaCliente.find(buscar)
                        function buscar (productoNuevoCliente){
                                return productoNuevoCliente.nombre == busquedaUsuario;
                        }
                        if(resultadoBusqueda != undefined){
                        alert(resultadoBusqueda.get_datos())
                        } else {
